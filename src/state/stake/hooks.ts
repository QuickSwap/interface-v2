...
export function useLairInfo(): LairInfo {
  ...
  const inputs = useMemo(() => ['1000000000000000000'], [])
  ...
  accountArg = useMemo(() => [LAIR_ADDRESS ?? undefined], [])
  ...
  }, [dQuickToQuick, quickToDQuick, quickBalance, dQuickBalance, lairsQuickBalance])
