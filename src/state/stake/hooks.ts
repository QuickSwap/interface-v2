...
import { GlobalAddresses, GlobalConst } from 'constants/index';
import {
...
export const SYRUP_REWARDS_INFO: {
  ...
  [ChainId.MATIC]: [
    {
      token: GlobalConst.tokens.PSP,
      stakingRewardAddress: '0xdcbDa338D12DBc823d0D484e7206E9AA55eeD844',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.MATIC,
      rate: 5555.55,
      ending: 1649254544,
    },
    {
      token: GlobalConst.tokens.CLAM2,
      stakingRewardAddress: '0xb510935f4D67E27a11cD94E81bF0C465ee2a5509',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.MI,
      rate: 83.33,
      ending: 1643900469,
    },
    {
      token: GlobalConst.tokens.BLANK,
      stakingRewardAddress: '0x5d6a48AF1a102CC9CD278fBd56b1Bdc833EeA1d0',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.USDC,
      rate: 2033,
      ending: 1646492469,
    },
    {
      token: GlobalConst.tokens.WELT,
    ...
    {
      token: GlobalConst.tokens.POLYPUG,
      stakingRewardAddress: '0xA206A97b30343a0802553dB48d71af349AbF563A',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.QUICK,
      rate: 177781944.44,
      ending: 1648223825,
    },
    {
      token: GlobalConst.tokens.EGG,
      stakingRewardAddress: '0x87C114Ca118987549e31f5023DfFF42041e446e4',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.USDT,
      rate: 3.99,
      ending: 1645631825,
    },
    {
      token: GlobalConst.tokens.PBR,
    ...
    {
      token: GlobalConst.tokens.GAMER,
      stakingRewardAddress: '0x35F1962fec6B4605ef3Be3b63396552fbf5e99d0',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.ETHER,
      rate: 1250,
      ending: 1645289231,
    },
    {
      token: GlobalConst.tokens.GNS,
      stakingRewardAddress: '0xF5F645A01A4a7f874C15eC7F7Baa7221a71C180d',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.DAI,
      rate: 833.3333333,
      ending: 1645289231,
    },
    {
      token: GlobalConst.tokens.MM,
    ...
    {
      token: GlobalConst.tokens.MATIC,
...
export const OLD_SYRUP_REWARDS_INFO: {
  ...
  [ChainId.MATIC]: [
    {
      token: GlobalConst.tokens.COMBO,
    ...
    {
      token: GlobalConst.tokens.EROWAN,
    ...
    {
      token: GlobalConst.tokens.XCASH,
    ...
    {
      token: GlobalConst.tokens.MCASH,
    ...
    {
      token: GlobalConst.tokens.WATCH,
    ...
    {
      token: GlobalConst.tokens.KNIGHT,
    ...
    {
      token: GlobalConst.tokens.ANGEL,
    ...
    {
      token: GlobalConst.tokens.TRADE,
    ...
    {
      token: GlobalConst.tokens.BUNNY,
    ...
    {
      token: GlobalConst.tokens.MOONED,
    ...
    {
      token: GlobalConst.tokens.HONOR,
    ...
    {
      token: GlobalConst.tokens.START,
    ...
    {
      token: GlobalConst.tokens.RELAY,
    ...
    {
      token: GlobalConst.tokens.CHICK,
    ...
    {
      token: GlobalConst.tokens.CIOTX,
    ...
    {
      token: GlobalConst.tokens.POLYDOGE,
    ...
    {
      token: GlobalConst.tokens.GUARD,
...
export const STAKING_DUAL_REWARDS_INFO: {
  ...
  [ChainId.MATIC]: [
    {
      tokens: [GlobalConst.tokens.MATIC, GlobalConst.tokens.ETHER],
      stakingRewardAddress: '0x3c1f53fed2238176419F8f897aEc8791C499e3c8',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.ETHER,
      rewardTokenA: GlobalConst.tokens.DQUICK,
      rewardTokenB: GlobalConst.tokens.MATIC,
      rewardTokenBBase: GlobalConst.tokens.USDC,
      rateA: 33.48,
      rateB: 1000,
      pair: '0xadbf1854e5883eb8aa7baf50705338739e558e5b',
    },
    {
      tokens: [GlobalConst.tokens.MATIC, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.MATIC, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.MATIC, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.KIRO, GlobalConst.tokens.MATIC],
      ...
      baseToken: GlobalConst.tokens.MATIC,
      rewardTokenA: GlobalConst.tokens.DQUICK,
      rewardTokenB: GlobalConst.tokens.KIRO,
      rewardTokenBBase: GlobalConst.tokens.MATIC,
      rateA: 2.232,
      rateB: 20000,
      pair: '0x3f245c6f18442bd6198d964c567a01bd4202e290',
    },
    {
      tokens: [GlobalConst.tokens.GENESIS, GlobalConst.tokens.QUICK],
      ...
      baseToken: GlobalConst.tokens.QUICK,
      rewardTokenA: GlobalConst.tokens.DQUICK,
      rewardTokenB: GlobalConst.tokens.GENESIS,
      rewardTokenBBase: GlobalConst.tokens.QUICK,
      rateA: 1.488,
      rateB: 25000,
      pair: '0xf0696be85fa54f7a8c9f20aa98aa4409cd5c9d1b',
    },
    {
      tokens: [GlobalConst.tokens.FODL, GlobalConst.tokens.MATIC],
      ...
      baseToken: GlobalConst.tokens.MATIC,
      rewardTokenA: GlobalConst.tokens.DQUICK,
      rewardTokenB: GlobalConst.tokens.FODL,
      rewardTokenBBase: GlobalConst.tokens.MATIC,
      rateA: 3.72,
      rateB: 14000,
    ...
    {
      tokens: [GlobalConst.tokens.PSP, GlobalConst.tokens.MATIC],
      ...
      baseToken: GlobalConst.tokens.MATIC,
      rewardTokenA: GlobalConst.tokens.DQUICK,
      rewardTokenB: GlobalConst.tokens.PSP,
      rewardTokenBBase: GlobalConst.tokens.MATIC,
      rateA: 5.208,
      rateB: 22223,
    ...
    {
      tokens: [GlobalConst.tokens.QUICK, GlobalConst.tokens.TEL],
      ...
      baseToken: GlobalConst.tokens.QUICK,
      rewardTokenA: GlobalConst.tokens.DQUICK,
      rewardTokenB: GlobalConst.tokens.TEL,
      rewardTokenBBase: GlobalConst.tokens.QUICK,
      rateA: 5.9534,
      rateB: 238095.24,
    ...
    {
      tokens: [GlobalConst.tokens.TEL, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.TEL, GlobalConst.tokens.USDC],
...
export const STAKING_REWARDS_INFO: {
  ...
  [ChainId.MATIC]: [
    {
      tokens: [GlobalConst.tokens.ETHER, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.WBTC, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.ETHER, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.ETHER, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.AAVE, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.DAI, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.DERC, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.WBTC, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.USDC, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.MSHEESHA, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.UST, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.MI, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.MI, GlobalConst.tokens.DAI],
    ...
    {
      tokens: [GlobalConst.tokens.USDC, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.GNS, GlobalConst.tokens.DAI],
    ...
    {
      tokens: [GlobalConst.tokens.POLYPUG, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.ORBS, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.LINK, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.LMT, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.WSG, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.MASQ, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.CLAM2, GlobalConst.tokens.MI],
    ...
    {
      tokens: [GlobalConst.tokens.EGG, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.SAND, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.PECO, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.MM, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.TECH, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.ELIXIR, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.GAMER, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.BLANK, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.STZ, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.RELAY, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.BCMC, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.ELON, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.SNE, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.SHIB, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.DAI, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.AVAX, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.SOL, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.BNB, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.FTM, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.MCRN, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.PNT, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.PBTC, GlobalConst.tokens.WBTC],
      stakingRewardAddress: '0x4bBaE7Ab87D2604dCA240c8eC00Be6dcD35295D4',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.WBTC,
      rate: 1.488,
      pair: '0x0850f9bf21cdba7d2817fca8e5f9d3b96feff3dd',
    },
    {
      tokens: [GlobalConst.tokens.ZIG, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.MANA, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.WCRO, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.PBR, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.WONE, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.HBAR, GlobalConst.tokens.MI],
    ...
    {
      tokens: [GlobalConst.tokens.TOMB, GlobalConst.tokens.MI],
    ...
    {
      tokens: [GlobalConst.tokens.UART, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.START, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.UFI, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.EROWAN, GlobalConst.tokens.ATOM],
      stakingRewardAddress: '0x70C674bCe0aEc05E0d13bFEdd692b2F231323899',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.ATOM,
      rate: 0.744,
      pair: '0x7051810a53030171f01d89e9aebd8a599de1b530',
    },
    {
      tokens: [GlobalConst.tokens.GMEE, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.EROWAN, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.UM, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.XPRT, GlobalConst.tokens.EROWAN],
      stakingRewardAddress: '0xA0395e5f54f396527322fb11D922e50707552176',
      ended: false,
      lp: '',
      name: '',
      baseToken: GlobalConst.tokens.EROWAN,
      rate: 0.744,
      pair: '0xf366df119532b2e0f4e416c81d6ff7728a60fe7d',
    },
    {
      tokens: [GlobalConst.tokens.AKT, GlobalConst.tokens.EROWAN],
    ...
    {
      tokens: [GlobalConst.tokens.DES, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.REVV, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.DAI, GlobalConst.tokens.USDT],
    ...
    {
      tokens: [GlobalConst.tokens.REVV, GlobalConst.tokens.QUICK],
    ...
    {
      tokens: [GlobalConst.tokens.GHST, GlobalConst.tokens.USDC],
    ...
    {
      tokens: [GlobalConst.tokens.WELT, GlobalConst.tokens.USDC],
...
export const OLD_STAKING_REWARDS_INFO: {
  ...
  [ChainId.MATIC]: [
    {
      tokens: [GlobalConst.tokens.UCO, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.AUMI, GlobalConst.tokens.MATIC],
    ...
    {
      tokens: [GlobalConst.tokens.ALN, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.IRIS, GlobalConst.tokens.EROWAN],
    ...
    {
      tokens: [GlobalConst.tokens.REGEN, GlobalConst.tokens.EROWAN],
    ...
    {
      tokens: [GlobalConst.tokens.MCASH, GlobalConst.tokens.ETHER],
    ...
    {
      tokens: [GlobalConst.tokens.ATOM, GlobalConst.tokens.QUICK],
...
export function useTotalRewardsDistributed() {
  ...
  const [, maticUsdcPair] = usePair(
    GlobalConst.tokens.MATIC,
    GlobalConst.tokens.USDC,
  );
  const quickPrice = Number(
    quickUsdcPair?.priceOf(GlobalConst.tokens.QUICK)?.toSignificant(6),
  );
  const maticPrice = Number(
    maticUsdcPair?.priceOf(GlobalConst.tokens.MATIC)?.toSignificant(6),
  );
  ...
  const dualStakingRewardsUSD = dualStakingRewardsInfo.reduce(
    (total, item, index) => {
      ...
      if (item.rewardTokenBBase.equals(GlobalConst.tokens.USDC)) {
        rewardTokenBPrice = rewardTokenBPriceInBaseToken;
      } else if (item.rewardTokenBBase.equals(GlobalConst.tokens.QUICK)) {
...
export function useSyrupInfo(
  ...
  const USDPrice = useUSDCPrice(GlobalConst.tokens.QUICK);
    ...
    return rewardsAddresses.reduce<DualStakingInfo[]>(
      (memo, rewardsAddress, index) => {
        ...
        if (
          ...
          if (info[index].rewardTokenBBase.equals(GlobalConst.tokens.USDC)) {
            rewardTokenBPrice = rewardTokenBPriceInBaseToken;
          } else if (
            info[index].rewardTokenBBase.equals(GlobalConst.tokens.QUICK)
          ) {
            rewardTokenBPrice = rewardTokenBPriceInBaseToken * quickPrice;
          } else {
            rewardTokenBPrice = rewardTokenBPriceInBaseToken * maticPrice;
...
export function useLairInfo(): LairInfo {
  ...
  const quickPrice = quickUsdcPair
    ? Number(quickUsdcPair.priceOf(GlobalConst.tokens.QUICK).toSignificant(6))
    : 0;
  ...
  accountArg = [GlobalAddresses.LAIR_ADDRESS ?? undefined];
  ...
  return useMemo(() => {
    return {
      lairAddress: GlobalAddresses.LAIR_ADDRESS,
