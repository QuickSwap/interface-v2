...
import { FARMING_CENTER, NONFUNGIBLE_POSITION_MANAGER_ADDRESSES } from "constants/v3/addresses";
                                    ...
                                    <div className={"f f-ac mxs_w-100"}>
                                        <MouseoverTooltip text={`Current pool fee.`}>
                                            <Badge className={"mr-05 fs-085"}>
                                                {new Percent(existingPosition?.pool?.fee || 100, 1_000_000).toSignificant()}%
                                            </Badge>
                                        </MouseoverTooltip>
                            ...
                            <Card isDark={false} classes={"p-1 br-12"}>
                                <div className={"f c mb-05"}>
                                    ...
                                    {_fiatValueOfLiquidity?.greaterThan(new Fraction(1, 100)) ? (
                                        <span className={"fs-2"}>
                                            ${_fiatValueOfLiquidity.toFixed(2, { groupSeparator: "," })}
                                        </span>
                                    ) : (
                                        <span className={"fs-2"}>
                                            $-
