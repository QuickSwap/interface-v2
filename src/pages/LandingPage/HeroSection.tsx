      ...
      {loading ? (
        ...
        <>
          <Box style={{ maxWidth: '40%', marginBottom: '20px' }}>
            <Typography className='title'>Leading DEX on</Typography>
            <Typography className='title'>all Polygon Chains</Typography>
          </Box>
          <Box sx={{ maxWidth: '40%' }}>
            <Typography
              className='subTitle'
            ...
            <Typography className='subTitle'>{t('feeDescription')}</Typography>
          </Box>
        </>
      )}
