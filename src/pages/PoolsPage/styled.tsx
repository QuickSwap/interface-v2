...
export const ToggleContainer = styled.div`
  ...
  border: solid 1px #282d3e;
`;

export const ToggleInnerContainer = styled.div<{ active?: boolean }>`
  width: 44px;
  height: 28px;
  display: flex;
  align-items: center;
  ...
  border-radius: 8px;
  border: ${({ active }) => (active ? 'solid 1px #448aff' : 'none')};
  background-color: ${({ active }) => (active ? '#1b1e29' : 'transparent')};
`;
