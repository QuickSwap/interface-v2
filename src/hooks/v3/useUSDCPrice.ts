...
const USDC_V3_TOKEN = new Token(USDC.chainId, USDC.address, USDC.decimals, USDC.symbol, USDC.name);
const STABLECOIN_AMOUNT_OUT_ALL: CurrencyAmount<Token> = CurrencyAmount.fromRawAmount(USDC_V3_TOKEN, 1)
const STABLECOIN_AMOUNT_OUT_FILTERED: CurrencyAmount<Token> = CurrencyAmount.fromRawAmount(USDC_V3_TOKEN, 100_000e1)
