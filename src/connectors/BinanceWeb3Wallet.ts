...
type BinanceWeb3Provider = Provider & {
  isMetaMask?: boolean;
  isConnected?: () => boolean;
  detected?: BinanceWeb3Provider[];
  providers?: BinanceWeb3Provider[];
  chainId?: string;
};

export class NoBinanceWeb3Error extends Error {
  public constructor() {
    super('Binance Web3 Wallet not installed');
    this.name = NoBinanceWeb3Error.name;
    Object.setPrototypeOf(this, NoBinanceWeb3Error.prototype);
  }
}
 ...
 */
export interface BinanceWeb3ConstructorArgs {
  actions: Actions;
  options?: Parameters<typeof detectEthereumProvider>[0];
  onError?: (error: Error) => void;
}

export class BinanceWeb3Connector extends Connector {
  ...
  public async activate(
    ...
    return this.isomorphicInitialize()
      .then(async () => {
        if (!this.provider) throw new NoBinanceWeb3Error();
