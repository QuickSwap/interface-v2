...
var ws_1 = require("@ethersproject/providers/lib/ws");
        ...
        _this.websocket.onmessage = function (messageEvent) {
            ...
            if (result.id != null) {
                ...
                if (sub) {
                    ...
                    if(Array.isArray(result.params.result)){
                        sub.processFunc(result.params.result[0]);
                    }else{
                ...
                try {
                    console.log("Trying close to reconnect");
