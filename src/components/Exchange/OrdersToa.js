...
export default function OrdersToa(props) {
  ...
  return (
    <Modal setIsVisible={setIsVisible} isVisible={true} label="Enable Orders" className="Orders-toa enable-orders" zIndex="1000">
      <div style={{ padding: 10 }}>
        ...
        <ul>
          ...
          <li>The mkt. price which is an aggregate of exchange prices did not reach the specified price</li>
        ...
        <button
          ...
          className="App-cta Confirmation-box-button enable-order-button"
