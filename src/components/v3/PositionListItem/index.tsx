...
export default function PositionListItem({
  ...
  return (
    <NavLink
      ...
      id={isNewest && highlightNewest ? 'newest' : ''}
    >
      <Card isDark={false} classes={'br-24 p-1 mv-05'}>
        <div className={'position-list-item__header f f-ac'}>
          ...
          <div
            className={
              'position-list-item__header__badges flex-s-between w-100'
            }
          >
            {_onFarming ? (
              <NavLink
        ...
        {priceLower && priceUpper ? (
          <div
            className={
              'position-list-item__bottom f fs-085 mt-025 c-w mt-05 mxs_fd-c mxs_f-ac'
            }
          >
            <div className={'f mxs_mb-05'}>
              <div className={'position-list-item__prefix mr-025'}>Min:</div>
            ...
            <div className={'f'}>
              <span className={'position-list-item__prefix mh-025'}>Max:</span>
              <span className={'position-list-item__amount'}>
