...
export default function StakeModalFarmingTiers({ tiersLimits, tiersMultipliers, selectTier, lockedToken }: { tiersLimits: any; tiersMultipliers: any; selectTier: any; lockedToken: any }) {
    ...
    const balance = useCurrencyBalance(account ?? undefined, new Token(ChainId.MATIC, lockedToken.id, +lockedToken.decimals, lockedToken.symbol, lockedToken.name) ?? undefined);
    ...
    return (
        <div className="f c">
            <div className="f-ac f farming-tier__balance br-8 mb-1">
                ...
                <div>
                    <div className="f">
                        <CurrencyLogo currency={new Token(ChainId.MATIC, lockedToken.id, +lockedToken.decimals, lockedToken.symbol, lockedToken.name) as WrappedCurrency} />
