...
export function StakeModal({
    ...
    const balance = useCurrencyBalance(
        account ?? undefined,
        lockedToken ? new Token(ChainId.MATIC, lockedToken.id, +lockedToken.decimals, lockedToken.symbol, lockedToken.name) : undefined
    );
    ...
    const _amountForApprove = useMemo(() => {
        ...
        return CurrencyAmount.fromRawAmount(new Token(ChainId.MATIC, lockedToken.id, +lockedToken.decimals, lockedToken.symbol, lockedToken.name), selectedTier);
    }, [selectedTier, lockedToken]);

    const [approval, approveCallback] = useApproveCallback(_amountForApprove, FARMING_CENTER[ChainId.MATIC]);
